...
public class SuperArray implements ListInt
{
  ...
  {
      int temp = _data[index]; //stores to-be-removed value
    ...
    public static void main( String[] args ) 
  {
    ...
    ListInt mayfield = new SuperArray(); //instantiates MAYFIELD as type ListInt but built using template SuperArray
    ...
    System.out.println("Printing _size of ListInt mayfield...");
    System.out.println(mayfield.size());

    System.out.println("Printing removed value");
    ...
    mayfield.set(0,100);
    System.out.println("Printing ListInt mayfield post-overwrite...");
    System.out.println(mayfield);

    System.out.println("Printing value at index 0 of ListInt mayfield...");
