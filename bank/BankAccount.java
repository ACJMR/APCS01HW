// Team Cookie, Team #8 (Code adapted from Team #2)
// Colin Hosking, Max Millar, George Liang 
// APCS1 pd8
...
public class BankAccount
{
    ...
    public BankAccount(){ //Default constructor which sets default values for the inst vars
	    name = "";
	    passwd = "";
	    pin = 0;
	    acctNum = 0;
